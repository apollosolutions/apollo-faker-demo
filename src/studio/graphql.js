...
export function getSdk(client, withWrapper = defaultWrapper) {
    return {
        LatestApprovedLaunch(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(LatestApprovedLaunchDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'LatestApprovedLaunch');
        },
        SubgraphSdls(variables, requestHeaders) {
            return withWrapper((wrappedRequestHeaders) => client.request(SubgraphSdlsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphSdls');
        }
    };
}
